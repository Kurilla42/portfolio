...
const PRICING_PLANS = [
  ...
  {
    id: "03",
    title: "Fast AI-Powered Landing Page: Budget Starter",
              ...
              {PRICING_PLANS.map((plan, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className={cn(
                      "text-lg md:text-[1.5vw] font-bold tracking-tight transition-colors duration-500 uppercase",
                  ...
                  >
                    <div className="flex flex-col md:flex-row justify-between items-start mb-6 gap-6">
                      <div className="w-full">
                        ...
                        <h3 className="text-2xl md:text-[2.5vw] font-black uppercase text-white mb-2">
                          {PRICING_PLANS[activeIndex].title}
                        </h3>
                        <p className="text-sm md:text-[1.1vw] text-accent font-bold leading-relaxed max-w-2xl mb-4 italic">
                          {PRICING_PLANS[activeIndex].description}
                        </p>
                        <div className="mb-6">
                          <span className="label text-white/30 block mb-2 tracking-widest text-[10px] uppercase font-mono">[ WHO IS THIS FOR ]</span>
                          <p className="text-sm md:text-[1vw] text-white/70 leading-relaxed font-medium">
                      ...
                      <div className="text-left md:text-right w-full md:w-auto shrink-0">
                        <span className="label text-white/40 block mb-2 text-[10px]">Investment</span>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-8">
                      <div>
                        <span className="label text-white/30 block mb-4 tracking-widest text-[10px] uppercase font-mono">[ WHAT'S INCLUDED ]</span>
                        <ul className="space-y-3">
                          {PRICING_PLANS[activeIndex].resources.map((resource, i) => (
                            <li key={i} className="flex items-start gap-4 text-xs md:text-sm text-white/80 font-medium">
                              <div className={cn("mt-1 w-4 h-4 rounded-full flex items-center justify-center shrink-0", PRICING_PLANS[activeIndex].color)}>
                      ...
                      <div className="flex flex-col justify-between h-full">
                        <div className="bg-white/5 rounded-2xl p-6 w-full border border-white/5 mb-6">
                          <p className="text-sm md:text-[0.9vw] text-white/60 leading-relaxed italic font-medium">
                            "{PRICING_PLANS[activeIndex].footerText}"
                          </p>
                        </div>
                        <Button className="w-full h-14 md:h-[4vw] bg-white text-black hover:bg-white/90 rounded-full font-bold uppercase tracking-widest text-xs md:text-[0.9vw] transition-transform hover:scale-[1.02]">
