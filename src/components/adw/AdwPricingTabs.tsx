...
const PRICING_PLANS = [
  {
    ...
    resources: [
      "Everything from the Google Ads, Meta and SEO packages",
      "Plan-vs-actual on KPIs and a forecast for the next period",
      "One real-time dashboard across all channels",
      "Cross-channel strategy and budget allocation",
      "Monthly strategic session",
      "Unified attribution model: each channel's contribution to results",
