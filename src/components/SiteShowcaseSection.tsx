...
export function SiteShowcaseSection() {
  ...
  // --- Анимация Появляющегося Фонового Текста ---
  const bgTextOpacity = useTransform(smoothProgress, [0.1, 0.5], [0, 1]);
          ...
          <div className="w-full h-full grid grid-cols-1 md:grid-cols-2 items-center px-6 md:px-[4vw] relative z-10 gap-8 md:gap-0">
            ...
            <div className="relative flex justify-center items-center h-[40vh] md:h-full">
              <motion.div 
                ...
                className="absolute text-3xl sm:text-4xl md:text-[6vw] font-black uppercase text-white z-20 pointer-events-none text-center leading-[0.8] tracking-tight"
              >
                EXPLORE<br />HOW YOUR
              </motion.div>
              <motion.div 
