    ...
    <div className="relative flex flex-col justify-center items-center h-[40vh] md:h-full text-center">
      ...
      >
        ...
        >
          ...
          >
            <div className="relative w-full h-full border border-[#e0ded8]/20 bg-[#1d1e1c]/20 flex flex-col shadow-2xl shadow-black/50">
              <Image 
                src={src} 
          ...
          <motion.div 
            ...
            className="absolute inset-0 bg-[#1d1e1c] z-20 pointer-events-none"
          />
        </motion.div>
