...
export function SiteShowcaseSection() {
  ...
  // --- Анимация Изображений и Фонового Текста (Выезд с самого низа экрана) ---
          ...
          <div className="w-full h-full grid grid-cols-2 items-center px-[4vw] relative z-10">
            ...
            <div className="relative flex justify-center items-center h-full">
              <motion.div 
                ...
                className="absolute heading-lg text-[6vw] text-white z-20 pointer-events-none text-center"
              >
                EXPLORE<br />HOW YOUR
              </motion.div>
              <motion.div 
