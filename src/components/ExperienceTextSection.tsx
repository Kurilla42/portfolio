...
const lines = [
  ...
  "think like designers, <span class='font-kurale font-bold bg-clip-text text-transparent bg-gradient-to-r from-[#b68d4d] to-[#c99b5d] inline-block'>not marketers</span>"
];
